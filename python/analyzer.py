...
# Логика: сначала проверяем приоритетные слова (high/low),
# потом ищем совпадения в категориях. Если ничего не нашли —
# возвращаем значения по умолчанию: medium / general.
HIGH_PRIORITY_WORDS = [
